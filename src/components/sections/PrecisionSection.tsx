      ...
      <div className="container-wide">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
          {METRICS.map((metric, i) => (
            <div key={metric.key} data-assemble="scale" data-assemble-delay={`${4 + i}`} className="text-center p-5 sm:p-6 md:p-8 lg:p-10 border border-white/[0.04] bg-[var(--graphite)]/50">
