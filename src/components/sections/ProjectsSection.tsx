...
const PROJECTS = [
  {
    ...
    image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=900&h=700&fit=crop&q=80",
  ...
  },
  {
    ...
    category: "gates",
    aspect: "",
    image: "https://images.unsplash.com/photo-1530639834082-05bafb67fbbe?w=600&h=400&fit=crop&q=80",
  ...
  },
  {
    ...
    alt: "Metal staircase design",
  },
  {
    id: 4,
    category: "fences",
    aspect: "sm:col-span-2",
    image: "https://images.unsplash.com/photo-1597423244036-ef5020e83f3c?w=900&h=400&fit=crop&q=80",
          ...
          {PROJECTS.map((project, i) => (
            ...
            >
              <Image
                ...
                alt={project.alt}
                fill
                className="object-cover transition-transform duration-700 md:group-hover:scale-105 brightness-[0.55] md:group-hover:brightness-[0.7]"
