...
const PROJECTS = [
  ...
  { id: 3, category: "staircases", aspect: "", image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=600&h=400&fit=crop&q=80", alt: "Metal staircase design" },
  { id: 4, category: "fences", aspect: "sm:col-span-2", image: "https://images.unsplash.com/photo-1597423244036-ef5020e83f3c?w=900&h=400&fit=crop&q=80", alt: "Architectural metal work" },
] as const;
          ...
          {PROJECTS.map((project, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-4 sm:p-5">
                <span className="eng-label text-[var(--copper)] text-[11px]">{project.category}</span>
              </div>
              {/* Edge gleam on hover */}
              <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[var(--copper)]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            </div>
          ))}
        </div>
      </div>
