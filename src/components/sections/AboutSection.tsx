        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            <div className="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
              {STATS.map((stat, i) => (
                <div key={stat.key} data-assemble="right" data-assemble-delay={`${i + 2}`} className="flex items-center gap-4 sm:gap-6 p-4 sm:p-5 lg:p-6 inset-chamber grinding-marks pressure-hover">
