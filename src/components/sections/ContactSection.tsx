      ...
      <div className="container-wide relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Hours */}
            <div data-assemble="up" data-assemble-delay="4" className="mt-6 flex items-center gap-3 opacity-25">
          ...
          <div data-assemble="right" data-assemble-delay="4" className="flex items-center">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2">
                <span className="eng-label opacity-30">CONTACT FORM</span>
                <span className="eng-label opacity-15">REQ-001</span>
              </div>
