    ...
    <AssembleSection id="services" className="section-padding relative scratches weld-seam section-edges base-layer">
      ...
      <div className="container-wide">
        ...
        <div className="mb-10 sm:mb-14 md:mb-20">
          <span data-assemble="up" data-assemble-delay="0" className="inline-block text-[11px] uppercase tracking-[0.2em] text-[var(--copper)] font-medium eng-label">{tSection("subtitle")}</span>
        ...
        {/* Services grid -- machined steel modules */}
